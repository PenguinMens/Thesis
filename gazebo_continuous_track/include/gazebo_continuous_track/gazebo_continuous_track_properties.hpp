...
private:
  ...
  static sdf::ElementPtr LoadPluginFormat() {
    ...
    std::string sdf_path = package_path + "/sdf/continuous_track_plugin.sdf";

    GZ_ASSERT(sdf::initFile(sdf_path, fmt), "Cannot initialize sdf by continuous_track_plugin.sdf");
    return fmt;
  }
