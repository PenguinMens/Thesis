...
void imu_calibration_callback(const void * request_msg, void * response_msg){
  // Cast messages to expected types
    std_srvs__srv__Trigger_Request * req_in =
...
int main()
{
    ...
    //icm42688_calibrate_gyro(i2c_default,2000); // will take 2000 * 5ms
    ...
    // Initialize motors
        ...
        msg_int_test.data = 0;
        res.success = false;
        res.message.data = "Calibration failed!";
        ...
        rclc_executor_add_service(&executor, &service,&req, &res, &imu_calibration_callback);
    #else
